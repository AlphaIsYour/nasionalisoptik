...
@php
function getWhatsAppLink($serviceId) {
    $phone = '6282143476748'; // Format internasional
    $messages = [
        1 => 'Halo Optik Nasionalis, saya ingin melakukan *Pemeriksaan Mata*. Mohon informasi lebih lanjut.',
        2 => 'Halo Optik Nasionalis, saya ingin menggunakan layanan *Pembersihan dan Perawatan Kacamata Gratis*. Mohon informasi lebih lanjut.',
        3 => 'Halo Optik Nasionalis, saya ingin melakukan *Penyesuaian Frame Kacamata*. Mohon informasi lebih lanjut.',
        4 => 'Halo Optik Nasionalis, saya ingin *Konsultasi Pemilihan Lensa & Frame*. Mohon informasi lebih lanjut.'
    ];
    
    $message = isset($messages[$serviceId]) ? $messages[$serviceId] : 'Halo Optik Nasionalis, saya ingin bertanya tentang layanan Anda.';
...
$(document).ready(function() {
    ...
    function generateProductCard(product) {
        const imageUrl = product.primary_image ? `${product.primary_image.image_path}` : '/image/products/default.jpg';
