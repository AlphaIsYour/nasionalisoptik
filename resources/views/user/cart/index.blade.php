            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-4">
                    @foreach($cartItems as $item)
                        <div class="bg-white border border-gray-200 p-6 flex gap-6">
                            <!-- Product Image -->
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white border border-gray-200 p-6 sticky top-4">
                        ...
                        <div class="space-y-4 mb-6">
                            ...
                            {{-- Uncomment jika sudah ada fitur ongkir
                            <div class="flex justify-between text-gray-600">
                        ...
                        <a href="{{ route('checkout.index') }}" class="block w-full bg-[#70574D] text-white text-center py-3 px-4 font-medium hover:opacity-90 transition">
                            Checkout
                        </a>
