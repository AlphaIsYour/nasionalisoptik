                ...
                @if($order->payment_status === 'pending')
                    ...
                    @if($order->payment_proof)
                        <div class="mb-4">
                            ...
                            <img src="{{ $order->payment_proof }}" alt="Bukti Transfer" class="max-w-xs border border-gray-300">
                        </div>
                    @endif
                    ...
                    <div class="flex gap-4 pb-4 border-b border-gray-100 last:border-0">
                        <div class="w-20 h-20 bg-gray-100 flex-shrink-0">
                                    @if($item->product && $item->product->primaryImage)
                                        <img src="{{ $item->product->primaryImage->image_path }}" alt="{{ $item->product_name }}" class="w-full h-full object-cover">
                                    @else
