...
<div class="min-h-screen flex mona-sans">
    ...
    <div class="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        <img src="/image/auth/register.jpg" alt="Optik Nasionalis" class="absolute inset-0 w-full h-full object-cover">
        ...
        <div class="relative z-10 flex items-center justify-center p-12">
            <div class="max-w-md text-white">
                ...
                <div class="mt-12">
                    <img src="/image/logo/nasionalisoptik.png" alt="Optik Nasionalis" class="w-48">
                </div>
            </div>
        </div>
    </div>
