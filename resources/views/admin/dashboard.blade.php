...
<div class="bg-white rounded-lg shadow p-6">
    <div class="flex items-center justify-between">
        <div>
            <p class="text-gray-600 text-sm">Pembayaran Pending</p>
            <p class="text-3xl font-bold text-gray-800 mt-1">{{ $stats['pending_payments'] }}</p>
        </div>
...
<div class="bg-white rounded-lg shadow p-6">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-3xl font-bold text-gray-800 mt-1">Rp {{ number_format($stats['total_revenue'], 0, ',', '.') }}</p>
        </div>
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="px-4 py-3">
                                @if($product->primaryImage)
                                    <img src="{{ $product->primaryImage->image_path }}" alt="{{ $product->name }}" class="w-12 h-12 rounded object-cover">
                                @else
