...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
    ...
    <div class="lg:col-span-2">
        ...
        <div class="bg-white rounded-lg shadow p-6 mb-6">
            ...
            <div class="divide-y">
                ...
                <div class="py-4 flex gap-4">
                    <img src="{{ $item->product->primaryImage->image_path ?? '' }}" alt="{{ $item->product->name }}" class="w-20 h-20 rounded object-cover">
                    <div class="flex-1">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="space-y-3">
                <img src="{{ $order->payment_proof }}" alt="Bukti Pembayaran" class="w-full max-w-xs rounded border">
