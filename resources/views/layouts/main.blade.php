...
<body class="min-h-screen flex flex-col">
    <!-- Navbar -->
    <nav id="navbar" class="bg-white shadow-md mona-sans fixed top-0 left-0 right-0 z-50">
        <div class="max-w-7xl mx-auto px-8 py-4 flex items-center gap-8">
            <img src="{{ asset('image/logo/nasionalisoptik.png') }}" alt="Logo Optik" class="w-[70px] h-[35px]">
